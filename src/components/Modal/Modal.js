    ...
    return (
      <div className={styles.modal}>
        <div className={styles.modal_window}>
            <div className={styles.modal_window_close} onClick={(event)=>{this.props.showModal();}}>
            ...
            <div className={styles.modal_window__title}>
                Создать магазин
            </div>
            <div className={styles.modal_window__selector_fields}>
                <div className={styles.modal_window__template_field}>
                    Шаблон
                    <div className={styles.modal_window__selector}>
                ...
                <div className={styles.modal_window__color_field}>
                    Цветовая схема
                    <div className={styles.modal_window__selector}>
                        <select name="template" id="1" className="form-select py-2" aria-label="Default select example">
            ...
            <div className={styles.domain}>
                ...
                <div className={"input-group " + styles.input}>
                    ...
                    <span class="input-group-text" id="basic-addon">.work5.ru</span> 
                </div>   
            </div>
