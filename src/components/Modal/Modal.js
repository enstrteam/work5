  ...
  render() {
    return (
      <div className={styles.modal}>
        <div className={"col-md-8 col-lg-7 col-xl-6 col-xxl-5 p-4 "+styles.modal_window}>
            <div className="d-flex">
                <div className={"me-auto mb-4 mb-xl-5 "+styles.modal_window__title}>
                    Создать магазин
                </div>
                <div className={styles.button_close} onClick={(event)=>{this.props.showModal();}}>
            ...
            <div className="gap-2 d-flex justify-content-between mb-3 mb-xl-4 ">
                <div className="col-5">
                    Шаблон
                    <div className="pt-1">
                        <select name="template" id="1" className="form-select py-2" aria-label="Default select example">
            ...
            <div className="mb-4">
                ...
                <div className="input-group pt-1">
                    <input type="text" class="form-control" placeholder='Например: ivangrozniy' aria-label='Например: ivangrozniy' aria-describedby="basic-addon"/>  
                    <span class="input-group-text px-3 px-sm-5 pt-2 pb-1" id="basic-addon">.work5.ru</span> 
                </div>   
            </div>
            <div className="d-flex align-items-center mb-4 mb-xl-5">
                ...
                <div className={styles.warning_text}>
                    ...
                    Подробнее по <a className="text-decoration-none" href="">ссылке</a>
                </div>
            </div>
            <div className={"gap-2 d-flex "+styles.button_group}>
                <button type="button" className={"btn py-2 px-5 "+styles.cancel}>
                    Отмена
                </button>
